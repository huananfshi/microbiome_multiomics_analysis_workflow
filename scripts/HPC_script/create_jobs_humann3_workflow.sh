...
JOB_TEMPLATE=humann3_TEMPLATE.pbs
...
WORK_DIRECTORY=/mount/durgan/EODF_result/
...
do
	...
	sed -e "s/SAMPLE_DIRECTORY/${sample_dir}/g" /mount/durgan/humann3_TEMPLATE.pbs >> /mount/durgan/EODF_result/humann3_${sample_dir}.pbs
